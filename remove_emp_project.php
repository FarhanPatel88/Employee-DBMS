<?php
    ...
    $sql_new = "update employee set project_id = NULL where emp_id = $emp_id_new and project_id = $pro_id_new";
    $alert = "Employee with ID: $emp_id has been removed from Project with ID: $pro_id";
            ...
            if(mysqli_query($con, $sql_new)) {
                ...
                echo '<script type="text/javascript">
                        ...
                        setInterval(function () {
                            location.replace("remove_emp_project.html")
                        }, 2000)
                    </script>';
            }
            else {
